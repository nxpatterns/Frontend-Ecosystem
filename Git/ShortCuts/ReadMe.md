...
A collection of useful Git shortcuts and commands to enhance your workflow (zshrc plugin git):

```bash
# Shows the complete list further below
❯ alias | grep '^g'

# Shows source of specific alias
❯ grep -r "alias ga=" ~/.oh-my-zsh/plugins/git/

# Shows source of specific alias, e.g.:
❯ grep "alias ga=" ~/.oh-my-zsh/plugins/git/git.plugin.zsh
alias ga='git add'
```
